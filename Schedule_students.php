...
while ($row = mysqli_fetch_array($result, MYSQLI_NUM)) {
    ...
    if (mysqli_query($conn, "INSERT INTO `scheduled`(`Schedule_id`,`Name`, `Enrollment`, `Jury_pannel`, `School`, `Discipline`, `Date`, `Time`, `Semester`, `Internal`, `Internal_2`) 
    VALUES ('', '$row[1]','$row[0]','$panel','$school','$branch','$date','$time_slot','$semester', '$internal', '$internal_2') ")) {
